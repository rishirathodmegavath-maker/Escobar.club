...
type Status = ContentStatus | CampaignStatus | KycStatus | PayoutStatus | ApprovalStatus | CampaignDisplayStatus | WalletTransactionStatus;
...
const styles: Record<Status, string> = {
  ...
  CONFIRMED: "bg-mint-soft text-mint-deep",
  REVERSED: "bg-ink-100 text-ink-500",
};
